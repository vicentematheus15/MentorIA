...
import respostasSchema from '../schemas/respostas.schema.js'
...
planoRoutes.post('/:id/diagnostica/enviar', limitadorEnviarDiagnostica, autenticar, dadosValidador(respostasSchema), controller.enviarDiagnostica);
